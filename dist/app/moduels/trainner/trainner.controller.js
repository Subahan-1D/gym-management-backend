...
const trainner_service_1 = require("./trainner.service");
const getAllTrainer = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield trainner_service_1.TrainerServices.getAllTrainerFromDB(req.query);
...
const getMySchedules = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield trainner_service_1.TrainerServices.getMySchedules(userEmail);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
